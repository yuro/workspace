...
import com.power.phone.PhoneConstants;
import com.power.service.IterationData;
import com.power.service.PowerData;
import com.power.util.ForegroundDetector;
import com.power.util.NativeLoader;
import com.power.util.Recycler;
    ...
    public OLED(Context context, PhoneConstants constants) {
      ...
      /* Don't have permission, try to change permission as root. */
            if (!readOk) {
                ...
                os.writeBytes("chown " + Process.myUid() +
                        " " + frameBufferFile.getAbsolutePath() + "\n");
                os.writeBytes("chown app_" + (Process.myUid() -
                        SystemInfo.AID_APP) +
                        " " + frameBufferFile.getAbsolutePath() + "\n");
